...
class productoControlador extends mainModel{
    ...
    public function registrar_producto_controlador(){
        ...
        $color=mainModel::limpiar_cadena($_POST['producto_color_reg']);
        $categoria=mainModel::limpiar_cadena($_POST['producto_categoria_reg']);
        $fecha_ingreso=mainModel::limpiar_cadena($_POST['fecha_ingreso_reg']);

        /*-- Comprobando campos vacios - Checking empty fields --*/
        if($codigo=="" || $nombre=="" || $precio_compra=="" || $precio_venta=="" || $stock_total==""){
            $alerta=[
                "Alerta"=>"simple",
    ...
    // Other methods can be updated similarly to use the new fields as needed.
}

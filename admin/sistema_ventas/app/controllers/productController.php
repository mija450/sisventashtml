...
$estado = isset($_POST['producto_estado']) ? $this->limpiarCadena($_POST['producto_estado']) : null; // Asegúrate que este campo existe
$unidad = $this->limpiarCadena($_POST['producto_unidad']);
$categoria = $this->limpiarCadena($_POST['categoria_id']);

// Nuevos campos
$color = isset($_POST['producto_color']) ? $this->limpiarCadena($_POST['producto_color']) : null; // Manejar posible ausencia
$fecha_ingreso = isset($_POST['producto_fecha_ingreso']) ? $this->limpiarCadena($_POST['producto_fecha_ingreso']) : null; // Manejar posible ausencia
$tipo_servicio = isset($_POST['servicio_id']) ? $this->limpiarCadena($_POST['servicio_id']) : null; // Manejar posible ausencia
    		...
    		$producto_datos_reg=[
				...
				[
					"campo_nombre"=>"fecha_ingreso",
					"campo_marcador"=>":FechaIngreso",
					"campo_valor"=>$fecha_ingreso
				],
			];
		...
		public function listarProductoControlador($pagina,$registros,$url,$busqueda,$categoria){
			...
			$campos="producto.producto_id,producto.producto_codigo,producto.producto_nombre,producto_stock,producto.producto_precio_venta,producto.producto_foto,categoria.categoria_nombre";

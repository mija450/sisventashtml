<?php
// Asegúrate de incluir el controlador de categorías
...
<div class="container pb-6 pt-6">
	<?php
		...
		$id = $insCategory->limpiarCadena($url[1]);

		// Llamar al método seleccionarDatos del controlador de categorías
		$datos = $insCategory->seleccionarDatos("Unico", "categoria", "categoria_id", $id);

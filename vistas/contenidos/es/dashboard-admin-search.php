...
<div class="container-fluid">
            ...
            <div class="row d-flex justify-content-center">
                <div class="col-12 col-md-6">
                    <div class="form-outline mb-4">
                        ...
                        <label for="txt_buscador" class="form-label">¿Qué administrador estás buscando?</label>
                    </div>
                    <p class="text-center">
    ...
    <div class="dashboard-container mb-4">
        ...
        <?php
            ...
            echo $ins_administrador->paginador_administrador_controlador($pagina[2],15,$pagina[1],$_SESSION[$pagina[1]]);
        ?>
    </div>
    <?php } ?>
</div>
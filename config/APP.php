<?php
	...
	----------*/
	const COMPANY="Mueblerias Cosme";
	...
	/*----------  
		Palabra clave dashboard - Panel Administrativo keyword
	...
	const DOCUMENTS_USERS=["DNI"];
	const DOCUMENTS_COMPANY=["DNI"];


	/*----------  Tipos de unidades de productos - Types of product units ----------*/
	const PRODUTS_UNITS=["Unidad"];
